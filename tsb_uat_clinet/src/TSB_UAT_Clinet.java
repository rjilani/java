...
public class TSB_UAT_Clinet {
    ...
    public static void main(String[] args) throws IOException, SAXException {
        ...
        processRequest(userId, password);
    }

    private static void processRequest(String userId, String password) throws IOException, SAXException {
...
//            System.out.println(methodsAndSchema);
            ...
            String response = processService(message, userId, password);
...
//            System.out.println(validateXMLSchema("./schema/response/" + schemaName, response));
    ...
    private static String processService(java.lang.String xmlToProcess, String userid, String password) {
    ...
    public static boolean validateXMLSchema(String xsdPath, String response) throws SAXException {
